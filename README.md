...
python build.py [options]
  ...
  --php-file PATH     index.php to extract CSS/JS from (default: ./index.php)
```
...
## Do I still need `index.php`?

Yes — `build.py` reads `index.php` at build time to extract the CSS and JavaScript for the site. You don't run it as a web server, but it must stay in the repository alongside `build.py`.
